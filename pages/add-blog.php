...
<!--                        <form action="action.php" method="POST">-->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="date" class="form-control" name="author"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="featuredCheckbox1" value="isFeatured">
                                    <label class="form-check-label" for="inlineCheckbox1">Featured Post</label>
                                </div>
                            <div class="row">
                                <div class="col-md-3"></div>
                                <div class="col-md-9 mb-5">
                                    <input type="submit" class="btn btn-outline-success px-4" name="btn" value="Create New Blog">
                                </div>
                            </div>
                        </form>
                    </div>
